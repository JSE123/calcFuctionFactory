...
mas.addEventListener("click", function(){
    ...
    //se borran los datos ingresados en la pantalla
    resultado.innerText = "0";
    signoAnt = "+";
...
igual.addEventListener("click", function(){
    //se guarda el valor ingresado en la variable a
    a = valor1;
    
    // se guarda el valor ingresado en la variable b
    b = parseFloat(resultado.innerText); 
    resolver = calculadora(a,b);
    // console.log(a);
    // console.log(b);
...
function resolverOperacion(){
    switch(signoAnt){
        ...
        case "-":
            ...
            break;
        case "/":
            res = resolver.dividir();
            break;
        case "*":
            res = resolver.multiplicar();
            break;
        default:
            break;
